...
$p_2_especies_imagen_completo_blobview = NULL; // Initialize page object first

class cp_2_especies_imagen_completo_blobview extends c_2_especies {
	...
	// Page object name
	var $PageObjName = 'p_2_especies_imagen_completo_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('_2_especies', 'x_imagen_completo');
...
// Create page object
if (!isset($p_2_especies_imagen_completo_blobview)) $p_2_especies_imagen_completo_blobview = new cp_2_especies_imagen_completo_blobview();

// Page init
$p_2_especies_imagen_completo_blobview->Page_Init();

// Page main
$p_2_especies_imagen_completo_blobview->Page_Main();
?>
<?php
$p_2_especies_imagen_completo_blobview->Page_Terminate();
?>
