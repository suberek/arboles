...
$especies_imagen_flor_blobview = NULL; // Initialize page object first

class cespecies_imagen_flor_blobview extends cespecies {
	...
	// Page object name
	var $PageObjName = 'especies_imagen_flor_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('especies', 'x_imagen_flor');
...
// Create page object
if (!isset($especies_imagen_flor_blobview)) $especies_imagen_flor_blobview = new cespecies_imagen_flor_blobview();

// Page init
$especies_imagen_flor_blobview->Page_Init();

// Page main
$especies_imagen_flor_blobview->Page_Main();
?>
<?php
$especies_imagen_flor_blobview->Page_Terminate();
?>
