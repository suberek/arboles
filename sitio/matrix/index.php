...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->AllowList(CurrentProjectID() . 'individuos'))
		$this->Page_Terminate("individuoslist.php"); // Exit and go to default page
		if ($Security->AllowList(CurrentProjectID() . 'especies'))
			$this->Page_Terminate("especieslist.php");
		if ($Security->AllowList(CurrentProjectID() . 'familias'))
			$this->Page_Terminate("familiaslist.php");
