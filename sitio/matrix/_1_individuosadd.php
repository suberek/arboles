...
$p_1_individuos_add = NULL; // Initialize page object first

class cp_1_individuos_add extends c_1_individuos {
	...
	// Page object name
	var $PageObjName = 'p_1_individuos_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "_1_individuosview.php")
	...
	function LoadDefaultValues() {
		...
		$this->id_fuente->CurrentValue = NULL;
	...
	function AddRow($rsold = NULL) {
		...
		// ALTURA_TOT
		$this->ALTURA_TOT->SetDbValueDef($rsnew, $this->ALTURA_TOT->CurrentValue, 0, FALSE);

		// DIAMETRO
		$this->DIAMETRO->SetDbValueDef($rsnew, $this->DIAMETRO->CurrentValue, 0, FALSE);

		// INCLINACIO
		$this->INCLINACIO->SetDbValueDef($rsnew, $this->INCLINACIO->CurrentValue, 0, FALSE);
		...
		// alt_ini
		$this->alt_ini->SetDbValueDef($rsnew, $this->alt_ini->CurrentValue, 0, FALSE);

		// espacio_verde
		$this->espacio_verde->SetDbValueDef($rsnew, $this->espacio_verde->CurrentValue, "", FALSE);
		...
		// id_fuente
		$this->id_fuente->SetDbValueDef($rsnew, $this->id_fuente->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($p_1_individuos_add)) $p_1_individuos_add = new cp_1_individuos_add();

// Page init
$p_1_individuos_add->Page_Init();

// Page main
$p_1_individuos_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$p_1_individuos_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var p_1_individuos_add = new ew_Page("p_1_individuos_add");
p_1_individuos_add.PageID = "add"; // Page ID
var EW_PAGE_ID = p_1_individuos_add.PageID; // For backward compatibility

// Form object
var f_1_individuosadd = new ew_Form("f_1_individuosadd");

// Validate form
f_1_individuosadd.Validate = function() {
...
f_1_individuosadd.Form_CustomValidate = 
...
f_1_individuosadd.ValidateRequired = true;
<?php } else { ?>
f_1_individuosadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
f_1_individuosadd.Lists["x_id_especie"] = {"LinkField":"x_id_especie","Ajax":true,"AutoFill":false,"DisplayFields":["x_NOMBRE_CIE","x_NOMBRE_COM","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $p_1_individuos_add->ShowPageHeader(); ?>
<?php
$p_1_individuos_add->ShowMessage();
?>
<form name="f_1_individuosadd" id="f_1_individuosadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="_1_individuos">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl__1_individuosadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
var oas = new ew_AutoSuggest("x_id_especie", f_1_individuosadd, true, EW_AUTO_SUGGEST_MAX_ENTRIES);
...
f_1_individuosadd.AutoSuggests["x_id_especie"] = oas;
</script>
</span>
...
<script type="text/javascript">
f_1_individuosadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$p_1_individuos_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$p_1_individuos_add->Page_Terminate();
?>
