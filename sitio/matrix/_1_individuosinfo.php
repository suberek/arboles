...
//
// Table class for 1_individuos
//
class c_1_individuos extends cTable {
	var $id_individuo;
	var $ALTURA_TOT;
	var $DIAMETRO;
	var $INCLINACIO;
	...
	function __construct() {
		...
		$this->TableVar = '_1_individuos';
		$this->TableName = '1_individuos';
		...
		// id_individuo
		$this->id_individuo = new cField('_1_individuos', '1_individuos', 'x_id_individuo', 'id_individuo', '`id_individuo`', '`id_individuo`', 3, -1, FALSE, '`id_individuo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_individuo->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_individuo'] = &$this->id_individuo;

		// ALTURA_TOT
		$this->ALTURA_TOT = new cField('_1_individuos', '1_individuos', 'x_ALTURA_TOT', 'ALTURA_TOT', '`ALTURA_TOT`', '`ALTURA_TOT`', 3, -1, FALSE, '`ALTURA_TOT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->ALTURA_TOT->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ALTURA_TOT'] = &$this->ALTURA_TOT;

		// DIAMETRO
		$this->DIAMETRO = new cField('_1_individuos', '1_individuos', 'x_DIAMETRO', 'DIAMETRO', '`DIAMETRO`', '`DIAMETRO`', 3, -1, FALSE, '`DIAMETRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->DIAMETRO->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['DIAMETRO'] = &$this->DIAMETRO;

		// INCLINACIO
		$this->INCLINACIO = new cField('_1_individuos', '1_individuos', 'x_INCLINACIO', 'INCLINACIO', '`INCLINACIO`', '`INCLINACIO`', 3, -1, FALSE, '`INCLINACIO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->INCLINACIO->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['INCLINACIO'] = &$this->INCLINACIO;

		// id_especie
		$this->id_especie = new cField('_1_individuos', '1_individuos', 'x_id_especie', 'id_especie', '`id_especie`', '`id_especie`', 3, -1, FALSE, '`EV__id_especie`', TRUE, TRUE, TRUE, 'FORMATTED TEXT');
		$this->id_especie->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_especie'] = &$this->id_especie;

		// calle
		$this->calle = new cField('_1_individuos', '1_individuos', 'x_calle', 'calle', '`calle`', '`calle`', 200, -1, FALSE, '`calle`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['calle'] = &$this->calle;

		// alt_ini
		$this->alt_ini = new cField('_1_individuos', '1_individuos', 'x_alt_ini', 'alt_ini', '`alt_ini`', '`alt_ini`', 3, -1, FALSE, '`alt_ini`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->alt_ini->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['alt_ini'] = &$this->alt_ini;

		// espacio_verde
		$this->espacio_verde = new cField('_1_individuos', '1_individuos', 'x_espacio_verde', 'espacio_verde', '`espacio_verde`', '`espacio_verde`', 200, -1, FALSE, '`espacio_verde`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['espacio_verde'] = &$this->espacio_verde;

		// lng
		$this->lng = new cField('_1_individuos', '1_individuos', 'x_lng', 'lng', '`lng`', '`lng`', 4, -1, FALSE, '`lng`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->lng->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['lng'] = &$this->lng;

		// lat
		$this->lat = new cField('_1_individuos', '1_individuos', 'x_lat', 'lat', '`lat`', '`lat`', 4, -1, FALSE, '`lat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->lat->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['lat'] = &$this->lat;

		// id_fuente
		$this->id_fuente = new cField('_1_individuos', '1_individuos', 'x_id_fuente', 'id_fuente', '`id_fuente`', '`id_fuente`', 3, -1, FALSE, '`id_fuente`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function SqlSelectList() { // Select for List page
		return "SELECT * FROM (" .
			"SELECT *, (SELECT CONCAT(`NOMBRE_CIE`,'" . ew_ValueSeparator(1, $this->id_especie) . "',`NOMBRE_COM`) FROM `2_especies` `EW_TMP_LOOKUPTABLE` WHERE `EW_TMP_LOOKUPTABLE`.`id_especie` = `1_individuos`.`id_especie` LIMIT 1) AS `EV__id_especie` FROM `1_individuos`" .
			") `EW_TMP_TABLE`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("_1_individuosview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("_1_individuosview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "_1_individuosadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("_1_individuosedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("_1_individuosadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("_1_individuosdelete.php", $this->UrlParm());
	}
