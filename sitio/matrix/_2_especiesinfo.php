...
//
// Table class for 2_especies
//
class c_2_especies extends cTable {
	var $id_especie;
	var $id_familia;
	var $NOMBRE_FAM;
	var $NOMBRE_CIE;
	...
	function __construct() {
		...
		$this->TableVar = '_2_especies';
		$this->TableName = '2_especies';
		...
		// id_especie
		$this->id_especie = new cField('_2_especies', '2_especies', 'x_id_especie', 'id_especie', '`id_especie`', '`id_especie`', 3, -1, FALSE, '`id_especie`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_especie->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_especie'] = &$this->id_especie;

		// id_familia
		$this->id_familia = new cField('_2_especies', '2_especies', 'x_id_familia', 'id_familia', '`id_familia`', '`id_familia`', 3, -1, FALSE, '`id_familia`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id_familia->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_familia'] = &$this->id_familia;

		// NOMBRE_FAM
		$this->NOMBRE_FAM = new cField('_2_especies', '2_especies', 'x_NOMBRE_FAM', 'NOMBRE_FAM', '`NOMBRE_FAM`', '`NOMBRE_FAM`', 200, -1, FALSE, '`NOMBRE_FAM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOMBRE_FAM'] = &$this->NOMBRE_FAM;

		// NOMBRE_CIE
		$this->NOMBRE_CIE = new cField('_2_especies', '2_especies', 'x_NOMBRE_CIE', 'NOMBRE_CIE', '`NOMBRE_CIE`', '`NOMBRE_CIE`', 200, -1, FALSE, '`NOMBRE_CIE`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOMBRE_CIE'] = &$this->NOMBRE_CIE;

		// NOMBRE_COM
		$this->NOMBRE_COM = new cField('_2_especies', '2_especies', 'x_NOMBRE_COM', 'NOMBRE_COM', '`NOMBRE_COM`', '`NOMBRE_COM`', 200, -1, FALSE, '`NOMBRE_COM`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['NOMBRE_COM'] = &$this->NOMBRE_COM;

		// TIPO_FOLLA
		$this->TIPO_FOLLA = new cField('_2_especies', '2_especies', 'x_TIPO_FOLLA', 'TIPO_FOLLA', '`TIPO_FOLLA`', '`TIPO_FOLLA`', 200, -1, FALSE, '`TIPO_FOLLA`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['TIPO_FOLLA'] = &$this->TIPO_FOLLA;

		// ORIGEN
		$this->ORIGEN = new cField('_2_especies', '2_especies', 'x_ORIGEN', 'ORIGEN', '`ORIGEN`', '`ORIGEN`', 200, -1, FALSE, '`ORIGEN`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['ORIGEN'] = &$this->ORIGEN;

		// ICONO
		$this->ICONO = new cField('_2_especies', '2_especies', 'x_ICONO', 'ICONO', '`ICONO`', '`ICONO`', 200, -1, TRUE, '`ICONO`', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['ICONO'] = &$this->ICONO;

		// imagen_completo
		$this->imagen_completo = new cField('_2_especies', '2_especies', 'x_imagen_completo', 'imagen_completo', '`imagen_completo`', '`imagen_completo`', 200, -1, TRUE, '`imagen_completo`', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['imagen_completo'] = &$this->imagen_completo;

		// imagen_hoja
		$this->imagen_hoja = new cField('_2_especies', '2_especies', 'x_imagen_hoja', 'imagen_hoja', '`imagen_hoja`', '`imagen_hoja`', 200, -1, TRUE, '`imagen_hoja`', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['imagen_hoja'] = &$this->imagen_hoja;

		// imagen_flor
		$this->imagen_flor = new cField('_2_especies', '2_especies', 'x_imagen_flor', 'imagen_flor', '`imagen_flor`', '`imagen_flor`', 200, -1, TRUE, '`imagen_flor`', FALSE, FALSE, FALSE, 'IMAGE');
		$this->fields['imagen_flor'] = &$this->imagen_flor;

		// descripcion
		$this->descripcion = new cField('_2_especies', '2_especies', 'x_descripcion', 'descripcion', '`descripcion`', '`descripcion`', 201, -1, FALSE, '`descripcion`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['descripcion'] = &$this->descripcion;

		// medicinal
		$this->medicinal = new cField('_2_especies', '2_especies', 'x_medicinal', 'medicinal', '`medicinal`', '`medicinal`', 201, -1, FALSE, '`medicinal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['medicinal'] = &$this->medicinal;

		// comestible
		$this->comestible = new cField('_2_especies', '2_especies', 'x_comestible', 'comestible', '`comestible`', '`comestible`', 201, -1, FALSE, '`comestible`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['comestible'] = &$this->comestible;

		// perfume
		$this->perfume = new cField('_2_especies', '2_especies', 'x_perfume', 'perfume', '`perfume`', '`perfume`', 16, -1, FALSE, '`perfume`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->perfume->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['perfume'] = &$this->perfume;

		// avejas
		$this->avejas = new cField('_2_especies', '2_especies', 'x_avejas', 'avejas', '`avejas`', '`avejas`', 16, -1, FALSE, '`avejas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->avejas->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['avejas'] = &$this->avejas;

		// mariposas
		$this->mariposas = new cField('_2_especies', '2_especies', 'x_mariposas', 'mariposas', '`mariposas`', '`mariposas`', 16, -1, FALSE, '`mariposas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			return $this->KeyUrl("_2_especiesview.php", $this->UrlParm($parm));
		else
			return $this->KeyUrl("_2_especiesview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	}

	// Add URL
	function GetAddUrl() {
		return "_2_especiesadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("_2_especiesedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("_2_especiesadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("_2_especiesdelete.php", $this->UrlParm());
	}
	...
	function ExportDocument(&$Doc, &$Recordset, $StartRec, $StopRec, $ExportPageType = "") {
		...
		if ($Doc->Horizontal) { // Horizontal format, write header
			...
			if ($ExportPageType == "view") {
				...
				if ($this->NOMBRE_FAM->Exportable) $Doc->ExportCaption($this->NOMBRE_FAM);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if ($ExportPageType == "view") {
					...
					if ($this->NOMBRE_FAM->Exportable) $Doc->ExportField($this->NOMBRE_FAM);
