...
$fuentes_add = NULL; // Initialize page object first

class cfuentes_add extends cfuentes {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("fuenteslist.php"); // No matching record, return to list
				}
				break;
...
// Create page object
if (!isset($fuentes_add)) $fuentes_add = new cfuentes_add();

// Page init
$fuentes_add->Page_Init();

// Page main
$fuentes_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$fuentes_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var fuentes_add = new ew_Page("fuentes_add");
fuentes_add.PageID = "add"; // Page ID
var EW_PAGE_ID = fuentes_add.PageID; // For backward compatibility

// Form object
var ffuentesadd = new ew_Form("ffuentesadd");

// Validate form
ffuentesadd.Validate = function() {
...
ffuentesadd.Form_CustomValidate = 
...
ffuentesadd.ValidateRequired = true;
<?php } else { ?>
ffuentesadd.ValidateRequired = false; 
<?php } ?>
...
<?php $fuentes_add->ShowPageHeader(); ?>
<?php
$fuentes_add->ShowMessage();
?>
<form name="ffuentesadd" id="ffuentesadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="fuentes">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl_fuentesadd" class="table table-bordered table-striped">
...
<input type="text" data-field="x_id" name="x_id" id="x_id" size="30" placeholder="<?php echo $fuentes->id->PlaceHolder ?>" value="<?php echo $fuentes->id->EditValue ?>"<?php echo $fuentes->id->EditAttributes() ?>>
</span>
