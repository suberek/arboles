...
$p_2_especies_ICONO_blobview = NULL; // Initialize page object first

class cp_2_especies_ICONO_blobview extends c_2_especies {
	...
	// Page object name
	var $PageObjName = 'p_2_especies_ICONO_blobview';
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('_2_especies', 'x_ICONO');
...
// Create page object
if (!isset($p_2_especies_ICONO_blobview)) $p_2_especies_ICONO_blobview = new cp_2_especies_ICONO_blobview();

// Page init
$p_2_especies_ICONO_blobview->Page_Init();

// Page main
$p_2_especies_ICONO_blobview->Page_Main();
?>
<?php
$p_2_especies_ICONO_blobview->Page_Terminate();
?>
