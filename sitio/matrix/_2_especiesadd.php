...
$p_2_especies_add = NULL; // Initialize page object first

class cp_2_especies_add extends c_2_especies {
	...
	// Page object name
	var $PageObjName = 'p_2_especies_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "_2_especiesview.php")
	...
	function LoadDefaultValues() {
		...
		$this->NOMBRE_FAM->CurrentValue = NULL;
		$this->NOMBRE_FAM->OldValue = $this->NOMBRE_FAM->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// NOMBRE_FAM
		$this->NOMBRE_FAM->SetDbValueDef($rsnew, $this->NOMBRE_FAM->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($p_2_especies_add)) $p_2_especies_add = new cp_2_especies_add();

// Page init
$p_2_especies_add->Page_Init();

// Page main
$p_2_especies_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$p_2_especies_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var p_2_especies_add = new ew_Page("p_2_especies_add");
p_2_especies_add.PageID = "add"; // Page ID
var EW_PAGE_ID = p_2_especies_add.PageID; // For backward compatibility

// Form object
var f_2_especiesadd = new ew_Form("f_2_especiesadd");

// Validate form
f_2_especiesadd.Validate = function() {
...
f_2_especiesadd.Form_CustomValidate = 
...
f_2_especiesadd.ValidateRequired = true;
<?php } else { ?>
f_2_especiesadd.ValidateRequired = false; 
<?php } ?>
...
<?php $p_2_especies_add->ShowPageHeader(); ?>
<?php
$p_2_especies_add->ShowMessage();
?>
<form name="f_2_especiesadd" id="f_2_especiesadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="_2_especies">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td>
<table id="tbl__2_especiesadd" class="table table-bordered table-striped">
...
<input type="text" data-field="x_id_especie" name="x_id_especie" id="x_id_especie" size="30" placeholder="<?php echo $_2_especies->id_especie->PlaceHolder ?>" value="<?php echo $_2_especies->id_especie->EditValue ?>"<?php echo $_2_especies->id_especie->EditAttributes() ?>>
</span>
...
<script type="text/javascript">
f_2_especiesadd.Init();
<?php if (EW_MOBILE_REFLOW && ew_IsMobile()) { ?>
ew_Reflow();
<?php } ?>
</script>
<?php
$p_2_especies_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$p_2_especies_add->Page_Terminate();
?>
