...
<meta property="og:description" content="Buscador de árboles para todas las ciudades del mundo. Datos obtenidos de los censos forestales publicados en los portales de datos abiertos de las municipalidades, y de colaboradores independientes. El objetivo principal de este sitio es simplificar el acceso a esta valiosa información esperando que colabore con el conocimiento y el cuidado de nuestro arbolado urbano." />
...
<meta name="description" content="Buscador de árboles para todas las ciudades del mundo. Datos obtenidos de los censos forestales publicados en los portales de datos abiertos de las municipalidades, y de colaboradores independientes.">
        ...
        <div class="col-md-4 col-lg-3" id="menu">
            <nav>
                ...
                <div class="row red">
                    ...
                    <div class="col-xs-12 col-sm-3 col-md-6">
                        <button class="btn btn-default btn-small btn-block Qué-es-esto?" data-toggle="modal" data-target="#Qué-es-esto?">Sobre el mapa</button></div>    
                </div>
