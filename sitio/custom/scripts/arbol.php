...
while ($row = mysqli_fetch_array($results)) {
  ...
  if ($i == $total_registros) {
    ...
    if (!empty($streetview)) {
      ...
      echo "<iframe width=\"100%\" height=\"400\" frameborder=\"0\" style=\"border:0\" src=\"https://www.google.com/maps/embed/v1/streetview?key=".$googleAPI."&location=".$lat.",".$lng."&heading=210&pitch=10&fov=35\" allowfullscreen></iframe>";
    }
