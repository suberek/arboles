    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-sm-10">
            <p>
              Escribí algunas letras en el cuadro de búsqueda y aparecerá un
              listado con las posibles especies.
            </p>
            <p>
              <small>
                Podés buscar todas las especies mezcladas, pero antes debes
                limitar la zona marcando un punto en el mapa.
              </small>
            </p>
          </div>
        </div>
    ...
    <div class="modal-content">
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-sm-10">
            <p>
              Opa, ¡esos son muchos árboles! Para buscar, empezá marcando un
              punto en el mapa.
            </p>
            <p>
              <small>
                Consejo piola: Podés buscar en toda la ciudad si seleccionás
                alguna especie.
              </small>
            </p>
          </div>
